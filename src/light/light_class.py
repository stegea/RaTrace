...
class LightSourceClass(QtWidgets.QWidget):
    ...
    def __init__(self, p0=np.array([0,0]), n0=np.array([1,0]), intensity=1, wavelength=660*nm, plot_color=varia.colormap_wavelength(wavelength=660*nm), is_visible=True, is_virtual=False):
    ...
    def plot_ray_and_children(self, graph, ray):
        ...
        if self.nr_of_rays_to_plot <= 10:     linewidth = 1.5
        elif self.nr_of_rays_to_plot <= 100:  linewidth = 1.0
        else:                                 linewidth = 0.5
...
class RayClass:
    ...
    def __init__(self, p0=np.array([0,0]), r=np.array([1,0]), wavelength=660*nm, N=N_air, intensity=None, ray_parent=None, source_element=None, lightsource_ID=None, plot_color=varia.colormap_wavelength(wavelength=660*nm), is_active=True, is_visible=True, is_virtual=False):
        ...
        self.source_element = source_element    # What element does the ray originates from
        self.lightsource_ID = lightsource_ID    # The ID of the original light source
        self.intensity  = intensity
